...
type FlatConfig struct {
	...
	TemporaryIamInstanceProfilePolicyArn      *string                                     `mapstructure:"temporary_iam_instance_profile_policy_arn" required:"false" cty:"temporary_iam_instance_profile_policy_arn" hcl:"temporary_iam_instance_profile_policy_arn"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"temporary_iam_instance_profile_policy_arn":      &hcldec.AttrSpec{Name: "temporary_iam_instance_profile_policy_arn", Type: cty.String, Required: false},
